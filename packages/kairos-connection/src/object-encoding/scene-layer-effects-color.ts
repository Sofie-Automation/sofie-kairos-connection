...
export const SceneLayerEffectYUVCorrectionObjectEncodingDefinition: ObjectEncodingDefinition<SceneLayerEffectYUVCorrectionObject> =
	{
...
export const SceneLayerEffectRGBCorrectionObjectEncodingDefinition: ObjectEncodingDefinition<SceneLayerEffectRGBCorrectionObject> =
	{
		enabled: { protocolName: 'enabled', parser: parseBoolean },
...
export const SceneLayerEffectLUTCorrectionObjectEncodingDefinition: ObjectEncodingDefinition<SceneLayerEffectLUTCorrectionObject> =
	{
		enabled: { protocolName: 'enabled', parser: parseBoolean },
		index: {
			protocolName: 'index',
			parser: (value) => parseEnum<SceneLayerEffectLUTCorrectionIndex>(value, SceneLayerEffectLUTCorrectionIndex),
		},
		inputColorspace: {
			protocolName: 'input_colorspace',
			parser: (value) =>
				parseEnum<SceneLayerEffectLUTCorrectionColorspace>(value, SceneLayerEffectLUTCorrectionColorspace),
		},
		outputColorspace: {
		...
		inputRange: {
			...
			parser: (value) => parseEnum<SceneLayerEffectLUTCorrectionRange>(value, SceneLayerEffectLUTCorrectionRange),
		},
		outputRange: {
...
export const SceneLayerEffectToneCurveCorrectionObjectEncodingDefinition: ObjectEncodingDefinition<SceneLayerEffectToneCurveCorrectionObject> =
	{
		enabled: { protocolName: 'enabled', parser: parseBoolean },
...
export const SceneLayerEffectMatrixCorrectionObjectEncodingDefinition: ObjectEncodingDefinition<SceneLayerEffectMatrixCorrectionObject> =
	{
		enabled: { protocolName: 'enabled', parser: parseBoolean },
...
export const SceneLayerEffectTemperatureCorrectionObjectEncodingDefinition: ObjectEncodingDefinition<SceneLayerEffectTemperatureCorrectionObject> =
	{
		enabled: { protocolName: 'enabled', parser: parseBoolean },
