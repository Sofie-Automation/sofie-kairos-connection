...
import { MediaObject, MediaStatus, protocolDecodeStr, LUTObject } from 'kairos-lib'
...
export const LUTObjectEncodingDefinition: ObjectEncodingDefinition<LUTObject> = {
	title: { protocolName: 'title', parser: (value) => protocolDecodeStr(value) },
	status: { protocolName: 'status', parser: (value) => parseEnum<MediaStatus>(value, MediaStatus) },
}
